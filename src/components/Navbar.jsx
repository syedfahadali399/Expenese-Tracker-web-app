...
function Navbar({view}) {
  ...
  return (
    <>
        <div className="flex flex-row justify-between items-center py-10 max-xl:py-8 max-md:flex-col max-md:gap-6">
            <div className="flex flex-col gap-3">
                <h1 className="text-4xl font-bold max-xl:text-3xl max-lg:text-3xl">{view}</h1>
                <p className="text-lg font-normal max-md:text-base">Welcome back, track your flow</p>
            </div>
            <div className="flex flex-row gap-4 items-center max-lg:flex-col max-lg:gap-4 max-md:flex-row max-md:gap-4">
